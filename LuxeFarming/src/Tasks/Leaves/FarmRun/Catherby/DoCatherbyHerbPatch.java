...
public class DoCatherbyHerbPatch extends Leaf {
    @Override
    public boolean isValid() {
        boolean isPlanted = HerbPatchesEnum.CATHERBY_HERB_PATCH.getPatchStatus() == PatchStatus.PLANTED;
        if(isPlanted && getSettings().catherby_herb_tp == 0) {
            getSettings().catherby_herb_tp = System.currentTimeMillis();
    ...
    @Override
    public int onLoop() {
        return FarmHerbs(HerbPatchesEnum.CATHERBY_HERB_PATCH);
    }
