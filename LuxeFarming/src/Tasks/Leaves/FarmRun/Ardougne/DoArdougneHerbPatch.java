...
public class DoArdougneHerbPatch extends Leaf {
    @Override
    public boolean isValid() {
        boolean isPlanted = HerbPatchesEnum.ARDOUGNE_HERB_PATCH.getPatchStatus() == PatchStatus.PLANTED;
        if(isPlanted && getSettings().ardougne_herb_tp == 0) {
            getSettings().ardougne_herb_tp = System.currentTimeMillis();
    ...
    @Override
    public int onLoop() {
        return FarmHerbs(HerbPatchesEnum.ARDOUGNE_HERB_PATCH);
    }
